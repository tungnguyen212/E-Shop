          ...
          <form className='space-y-6' onSubmit={handleSubmit}>
            <div>
              ...
              <div className='mt-1 '>
                <input
                  ...
                  className='appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-smplaceholder-gray-400
            ...
            <div>
              ...
              <div className='mt-2 flex items-center'>
                ...
                <label
                  htmlFor='file-input'
                  className='ml-5 flex px-4 py-2 border
